...
const API_GET_SEASON_BUNDESLIGA = `https://soccer.sportmonks.com/api/v2.0/leagues/8?api_token=${process.env.SPORTMONKS_API_CODE}`;
...
db.then(async () => {
  ...
  const PremierLeague = new League(finalData).save();
});
