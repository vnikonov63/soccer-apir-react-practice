...
const API_GET_SEASON_BUNDESLIGA = `https://soccer.sportmonks.com/api/v2.0/leagues/181?api_token=${process.env.SPORTMONKS_API_CODE}`;
...
db.then(async () => {
  ...
  const finalData = {
    LeagueName: "Tipico Bundesliga",
    LeagueId: 181,
    LeagueCountry: "Austria",
    Teams: formattedData,
  };
